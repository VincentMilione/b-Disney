...
<%
	Boolean warn = (Boolean) request.getAttribute("warning");
	if (warn != null ? warn : false) {
		%>
		<script type="text/javascript">
		alert ("Ops! a quanto pare uno o più prodotti da lei desiderati non sono più disponibili.\nLa consigliamo di refreshare la pagina per vedere la versione attuale del vostro carello, grazie...");
		</script>
		<% }
		%>
