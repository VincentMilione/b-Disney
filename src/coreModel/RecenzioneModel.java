...
import beans.RecenzioneBean;

public abstract class RecenzioneModel {

	public synchronized double mediumVote (beans.ProductBean e) throws SQLException {
	...
	public synchronized RecenzioneBean userComment (beans.Registered e, beans.ProductBean p) throws SQLException {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
	...
	public synchronized java.util.List<RecenzioneBean> getComments (beans.ProductBean e) throws SQLException {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
	...
	public synchronized void newComment (beans.Registered e, beans.ProductBean p, String comment, float valutation) throws SQLException {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
