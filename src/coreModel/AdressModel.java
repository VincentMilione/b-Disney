...
public abstract class AdressModel {
	...
	protected void prepareInsertStatement (PreparedStatement preparedStatement, beans.Registered e ,Adress address) throws SQLException {
	...
	public int doSave(Adress address, beans.Registered user) throws SQLException {
